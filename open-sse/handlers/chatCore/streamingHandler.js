 ...
 */
export async function handleStreamingResponse({ providerResponse, provider, model, sourceFormat, targetFormat, userAgent, body, requestDetailBody, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, clientRawRequest, onRequestSuccess, reqLogger, toolNameMap, streamController, onStreamComplete, streamDetailId, pxpipe, reqTag, log }) {
  if (onRequestSuccess) {
    Promise.resolve()
  ...
  saveRequestDetail(buildRequestDetail({
    ...
    request: extractRequestConfig(requestDetailBody || body, stream),
 ...
 */
export function buildOnStreamComplete({ provider, model, connectionId, apiKey, requestStartTime, body, requestDetailBody, stream, finalBody, translatedBody, clientRawRequest, pxpipe, reqTag, log }) {
